...
namespace MyCalculator.Mathematical {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="MathematicalOperationSoap", Namespace="http://tempuri.org/")]
    public partial class MathematicalOperation : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback remOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public MathematicalOperation() {
            this.Url = global::MyCalculator.Properties.Settings.Default.MyCalculator_Mathematical_MathematicalOperation;
        ...
        /// <remarks/>
        public event remCompletedEventHandler remCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/rem", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public int rem(int x, int y) {
            object[] results = this.Invoke("rem", new object[] {
                        x,
                        y});
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public void remAsync(int x, int y) {
            this.remAsync(x, y, null);
        }
        
        /// <remarks/>
        public void remAsync(int x, int y, object userState) {
            if ((this.remOperationCompleted == null)) {
                this.remOperationCompleted = new System.Threading.SendOrPostCallback(this.OnremOperationCompleted);
            }
            this.InvokeAsync("rem", new object[] {
                        x,
                        y}, this.remOperationCompleted, userState);
        }
        
        private void OnremOperationCompleted(object arg) {
            if ((this.remCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.remCompleted(this, new remCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1038.0")]
    public delegate void remCompletedEventHandler(object sender, remCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1038.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class remCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal remCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
